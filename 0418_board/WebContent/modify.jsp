		...
		<script type="text/javascript">
			function sendData(){
				for(var i=0 ; i<document.forms[0].elements.length ; i++){
					if(document.forms[0].elements[i].value == "" && i!=2){
				...
				if(document.forms[0].elements[3].value != "<%=bvo.getPwd()%>"){
					alert("암호가 틀렸습니다.");
			...
			encType="multipart/form-data">
				<table summary="글 수정하기">
					...
					<tbody>
						<tr>
							<th>제목:</th>
							<td><input type="text" name="title"  value="<%=bvo.getTitle()%>"  size="45"/></td>
						</tr>
						<tr>
							<th>이름:</th>
							<td><%=bvo.getWriter()%></td>
						...
						<tr>
							...
							<td>
								...
								<input type="hidden" name="filename2" value="<%=bvo.getFilename()%>" />
							</td>
						</tr>
						<tr>
							<td colspan="2">
