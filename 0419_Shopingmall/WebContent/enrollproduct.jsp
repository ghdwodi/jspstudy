...
<%
	...
	String memberidx = mvo.getMemberidx();
	...
	<head>
		...
		<script type="text/javascript">
			function send_go() {
				...
				enrollform.action="enroll_ok.jsp?p_num="+enrollform.p_num.value;
				enrollform.submit();
			}
		</script>
	</head>
			...
			<table>
				<tbody>
					...
					<tr>
						...
						onclick="javascript:location.href='memberpage.jsp?memberidx=<%=memberidx%>&name=<%=name%>'"/></td>
					</tr>
				</tbody>
			</table>
		</form>
